function Calibration = marsCalFireflyPGR(OS)
% linux
% matlab -nojvm -nodesktop -r "cd('/home/benjamin/ros/src/hast/cam_info');marsCalFireflyPGR('linux')" 
% OSX
% matlab -r "cd('/Users/benjamin/hast/ros/hast/cam_info');marsCalFireflyPGR('osx')" 

%% cal file name
cal.date = date;
%% cal file name
cal.filename = 'mars_firefly_20170725';
...
HOSTID = 'mars';
cal.camXOffset = 0.055;
cal.camYOffset = 0.0;
cal.camZOffset = 0.225;
Left.SERIAL  = '11470071';
Right.SERIAL = '11470083';
...
fprintf(Launch.fileID, '\t<arg name="%s_tf_id" default="%s" />\n', 'left', '/create/stereo_left');
fprintf(Launch.fileID, '\t<arg name="%s_tf_id" default="%s" />\n', 'right', '/create/stereo_right');
...
fprintf(Launch.fileID, '\t<node pkg="tf" type="static_transform_publisher" name="Base2StereoCenter" args="%6.6f %6.6f %6.6f -1.57079632679 0 -1.22173047640 /create/base_link /create/stereo_center 100"/> \n', cal.camXOffset, cal.camYOffset, cal.camZOffset);
fprintf(Launch.fileID, '\t<node pkg="tf" type="static_transform_publisher" name="stereo_left" args="%6.9f 0 0 0 0 0 /create/stereo_center $(arg left_tf_id) 100"/> \n', -Baseline/2);
fprintf(Launch.fileID, '\t<node pkg="tf" type="static_transform_publisher" name="stereo_right" args="%6.9f 0 0 0 0 0 /create/stereo_center $(arg right_tf_id) 100"/> \n', Baseline/2);
...
fprintf(Launch.fileID, '\t\t\t\t<rosparam file="/home/$(env USER)/.ros/camera_info/$(arg right_camera_serial).yaml" />\n');
fprintf(Launch.fileID, '\t\t\t</node>\n');
fprintf(Launch.fileID, '\t\t</group>\n');
fprintf(Launch.fileID, '\t</group>\n\n');
