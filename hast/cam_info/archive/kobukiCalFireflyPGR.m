function Calibration = kobukiCalFireflyPGR(OS)
% linux
% matlab -nojvm -nodesktop -r "cd('/home/turtlebot/ros/src/hast/cam_info');kobukiCalFireflyPGR('linux')" 
% OSX
% matlab -r "cd('/Users/benjamin/hast/ros/hast/cam_info');kobukiCalFireflyPGR('osx')" 
...
cal.launchpath = ['/Users/benjamin/hast/ros/hast/launch/'];
elseif strcmp(OS,'linux')
% linux paths
cal.path = ['/home/turtlebot/ros/src/hast/cam_info/'];
cal.matpath = ['/home/turtlebot/ros/data/calibrations/' cal.filename '/']; 
cal.launchpath = ['/home/turtlebot/ros/src/hast/launch/'];
end

HOSTID = 'kobuki';
cal.camXOffset = 0.0;
cal.camYOffset = 0.0;
cal.camZOffset = 0.225;
Left.SERIAL  = '13141240';
Right.SERIAL = '13141275';
...
fprintf(Launch.fileID, '\t<arg name="%s_tf_id" default="/$(arg tb_base)/stereo_%s" />\n', 'left', 'left');
fprintf(Launch.fileID, '\t<arg name="%s_tf_id" default="/$(arg tb_base)/stereo_%s" />\n', 'right', 'right');
...
fprintf(Launch.fileID, '\t<node ns="$(arg tb_base)" pkg="tf" type="static_transform_publisher" name="Base2StereoCenter" args="%6.6f %6.6f %6.6f -1.57079632679 0 -1.22173047640 /$(arg tb_base)/base_footprint /$(arg tb_base)/stereo_center 100"/> \n', cal.camXOffset, cal.camYOffset, cal.camZOffset);
fprintf(Launch.fileID, '\t<node ns="$(arg tb_base)" pkg="tf" type="static_transform_publisher" name="stereo_left" args="%6.9f 0 0 0 0 0 /$(arg tb_base)/stereo_center $(arg left_tf_id) 100"/> \n', -Baseline/2);
fprintf(Launch.fileID, '\t<node ns="$(arg tb_base)" pkg="tf" type="static_transform_publisher" name="stereo_right" args="%6.9f 0 0 0 0 0 /$(arg tb_base)/stereo_center $(arg right_tf_id) 100"/> \n', Baseline/2);
...
fprintf(Left.yamlID,'camera_info_url: file:///home/turtlebot/.ros/camera_info/${NAME}.yaml\n\n');
...
fprintf(Left.yamlID,'white_balance_blue: 650\n');
fprintf(Left.yamlID,'white_balance_red: 250\n');
...
fprintf(Right.yamlID,'camera_info_url: file:///home/turtlebot/.ros/camera_info/${NAME}.yaml\n\n');
...
fprintf(Right.yamlID,'white_balance_blue: 650\n');
fprintf(Right.yamlID,'white_balance_red: 250\n');
