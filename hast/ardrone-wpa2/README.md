...
3. Connect to a network with: ```script/connect "<essid>" -p "<password>" -a <address> -d <droneip>```
 .script/connect "hast" -p "stevens2015" -a 192.168.1.1 -d 129.168.1.240
. script/connect "D017EC24gh" -p "555c1180b111a" -a 192.168.1.1 -d 129.168.1.1
. script/connect "D017EC24gh" -p "555c1180b111a"
