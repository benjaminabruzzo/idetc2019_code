function Calibration = createCal_ChameleonPGR()
% matlab -nojvm -nodesktop -r "cd('/home/benjamin/ros/src/hast/cam_info');createCal_ChameleonPGR();quit" 
% matlab -nojvm -nodesktop -r "cd('/home/benjamin/ros/src/hast/cam_info');createCal_ChameleonPGR()" 
% OSX
% matlab -r "cd('/Users/benjamin/hast/ros/hast/cam_info');createCal_ChameleonPGR()" 
...
HOSTID = 'create';
    ...
    cal.camYOffset = 0.00;
    cal.camZOffset = 0.22;
    % Left.SERIAL  = '16369047'; % chamaeleon usb3
    Left.SERIAL  = '16306423'; % chamaeleon usb3
    Right.SERIAL = '16369047'; % chamaeleon usb3
...
% cal.filename = 'create_chameleon_20170728';
% cal.filename = 'create_chameleon_20170905';
% cal.filename = 'create_chameleon_20170912';
% cal.filename = 'create_chameleon_20170912b';
% cal.filename = 'create_chameleon_20170912c';
% cal.filename = 'create_chameleon_20170913a';
cal.filename = 'create_chameleon_20171106';
...
cal.launchpath = ['/home/benjamin/ros/src/hast/launch/create/'];
...
fprintf(Launch.fileID, '\t<arg name="tb_base" default="create" />\n');
fprintf(Launch.fileID, '\t<arg name="%s_tf_id" default="%s" />\n', 'left', '/hast/$(arg tb_base)/stereo_left');
fprintf(Launch.fileID, '\t<arg name="%s_tf_id" default="%s" />\n', 'right', '/hast/$(arg tb_base)/stereo_right');
