function Calibration = osxCal(HOSTID)
% echo "alias matlab='/Applications/MATLAB_R2017a.app/bin/matlab -nodesktop -nosplash $*'" >> ~/.bash_profile
% matlab -nojvm -nodesktop -r "createCal('create');quit" 
%% Host name
% clear all
% HOSTID = 'kobuki';
% HOSTID = 'create';
...
% if HOSTID =='kobuki'
if strcmp(HOSTID,'kobuki')
    cal.camXOffset = 0.075;
    cal.camYOffset = 0.0;
    cal.camZOffset = 0.24;
    Left.SERIAL  = '00b09d0100c8851b';
    Right.SERIAL = '00b09d0100c884f8';
%     HOSTUSER = 'turtlebot';
elseif strcmp(HOSTID,'create')
    cal.camXOffset = 0.055;
    cal.camYOffset = 0.0;
    cal.camZOffset = 0.225;
%     Left.SERIAL  = '16452463'; % blfy gige 
%     Right.SERIAL = '17094423'; % blfy gige
    Left.SERIAL  = '16369047'; % chamaeleon usb3
    Right.SERIAL = '16306423'; % chamaeleon usb3
%     HOSTUSER = 'turtlebot';
elseif strcmp(HOSTID,'mars')
    cal.camXOffset = 0.0;
    cal.camYOffset = 0.0;
    cal.camZOffset = 0.0;
    Left.SERIAL  = '16335922';
    Right.SERIAL = '17180307';
%     HOSTUSER = 'benjamin';
end
%% cal file name
...
cal.matpath = ['/Users/benjamin/hast/data/calibrations/' cal.filename '/']; 
cal.launchpath = ['/Users/benjamin/hast/ros/hast/launch/'];

% '/Users/benjamin/hast/ros/hast/cam_info'

try mkdir(cal.matpath); catch; end;
% try mkdir(cal.path); catch; end;

% savepath = [cal.path];
% savepath = ['~/ros/data/calibrations/' cal.filename '/'];

% formatOut = 'yyyymmdd';
% cal.date = datestr(now,formatOut);
...
% ----------- left group -----------
fprintf(Launch.fileID, '<!-- launch %s camera -->\n', 'left');
...
fprintf(Launch.fileID, '\t\t\t<param name="serial" value="$(arg %s_camera_serial)" />\n', 'left');
fprintf(Launch.fileID, '\t\t\t<param name="camera_info_url" if="$(arg %s_camera_calibrated)" value="file://$(env HOME)/ros/src/hast/cam_info/$(arg %s_camera_serial).yaml" /> \n', 'left', 'left');
...
fprintf(Launch.fileID, '\t\t\t<remap from="image" to="image_raw" />\n');
fprintf(Launch.fileID, '\t\t</node>\n');
fprintf(Launch.fileID, '\t</group>\n');
fprintf(Launch.fileID, '</group>\n\n');
...
fprintf(Left.yamlID,'white_balance_blue: 700\n');
fprintf(Left.yamlID,'white_balance_red: 700\n');
...
fprintf(Right.yamlID,'white_balance_blue: 700\n');
fprintf(Right.yamlID,'white_balance_red: 700\n');
